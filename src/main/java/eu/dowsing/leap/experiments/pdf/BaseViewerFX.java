...
public class BaseViewerFX extends Application {
    ...
    private String     password            = null;       // Holds the password
                                                          // from the JVM or
                                                          // from User input
    private boolean    closePasswordPrompt = false;      // boolean controls
                                                          // whether or not we
                                                          // should close the
                                                          // prompt box
    ...
    private float[]    scalings            = { 0.01f, 0.1f, 0.25f, 0.5f, 0.75f,
            1.0f, 1.25f, 1.5f, 2.0f, 4.0f, 7.5f, 10.0f };
